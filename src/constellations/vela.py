...
# star_names = create_star_dictionary(['gamma', 'delta', 'kappa', 'lambda', 'mu', 'o', 'phi', 'psi'])
#
# print(star_names)
...
vela_coordinates = array([
    ('08:09:31.95013', '-47:20:11.7108'),
    ('08:44:42.226', '-54:42:31.76'),
    ('09:22:06.81761', '-55:00:38.4017'),
    ('09:07:59.75787', '-43:25:57.3273'),
    ('10:46:46.17877', '-49:25:12.9244'),
    ('08:40:17.58553', '-52:55:18.8002'),
    ('09:56:51.742', '-54:34:04.04'),
    ('09:30:41.99958', '-40:28:00.2616')
])

draw_lines = get_reverse_map(
    [('psi', 'lambda'), ('lambda', 'gamma'), ('gamma', 'delta'), ('delta', 'kappa'), ('kappa', 'phi'), ('phi', 'mu'),
     ('mu', 'psi')
     ], star_names)
